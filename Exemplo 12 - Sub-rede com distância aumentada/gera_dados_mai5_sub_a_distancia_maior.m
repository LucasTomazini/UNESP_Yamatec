%% Geração de dados - sub-rede A do condomínio 1 - v7
...
d = epanet('rede-sub-a-v7.inp'); 
%Este modelo tem consumidores fora do "condomínio"
%Modelo com as coordenadas de cada ponto adequadas à matriz de adjacência
...
%% Execução do modelo SEM VAZAMENTO - 9 dias
% Dados preliminares
...
%% Vazamento no nó 12 - dia inteiro (3 dias)
% Dados preliminares
...
%% Vazamento no nó 12 - meio dia (3 dias)
% Dados preliminares
wkday = zeros(len,1) + 1;       % dia da semana
leak_array = [1 0];             % Apenas N12 vaza
...
%% Vazamento no nó 14 - dia inteiro (3 dias)
% Dados preliminares
wkday = zeros(len,1) + 1;       % dia da semana
...
%% Vazamento no nó 14 - meio dia (3 dias)
% Dados preliminares
wkday = zeros(len,1) + 1;       % dia da semana
leak_array = [0 1];             % apenas N14 vaza 
lktype = 'i';                   % tipo de vazamento (c=cte.; i=intermitente; n=nenhum)
...
% 1 a 9 - não vaza
% 10 a 12 - dia inteiro - nó 12
% 13 a 15 - meio dia - nó 12
% 16 a 18 - dia inteiro - nó 14 
% 19 a 21 - meio dia - nó 14
